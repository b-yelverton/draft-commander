...
- [x] **MOBI-03**: Header collapses on mobile — source pills hidden, shows logo and live indicator only
- [x] **MOBI-04**: Room tabs are horizontally scrollable on narrow viewports without overflow
- [x] **MOBI-05**: All interactive elements (buttons, tabs, filters) meet 44px minimum touch target on mobile viewports
...
| MOBI-03 | Phase 3 | Complete |
| MOBI-04 | Phase 3 | Complete |
| MOBI-05 | Phase 3 | Complete |
